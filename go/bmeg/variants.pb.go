...
func (*VariantSetMetadata) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{0} }
...
func (*VariantSet) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{1} }
...
func (*CallSet) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{2} }
...
func (*Call) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{3} }
...
func (*Variant) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{4} }
...
func (*TranscriptEffect) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{5} }
...
func (*VariantAnnotation) Descriptor() ([]byte, []int) { return fileDescriptor10, []int{6} }
...
func init() { proto.RegisterFile("bmeg/variants.proto", fileDescriptor10) }
