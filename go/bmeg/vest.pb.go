...
func (*VestScore) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0} }
...
func (*VestScore_Gene) Descriptor() ([]byte, []int) { return fileDescriptor7, []int{0, 0} }
...
func init() { proto.RegisterFile("bmeg/vest.proto", fileDescriptor7) }
