...
func (*ProteinInteraction) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{0} }
...
func (*Pathway) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{1} }
...
func (*ProteinInstance) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{2} }
...
func (*Complex) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{3} }
...
func (*Reaction) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{4} }
...
func (*Catalysis) Descriptor() ([]byte, []int) { return fileDescriptor9, []int{5} }
...
func init() { proto.RegisterFile("bmeg/pathway.proto", fileDescriptor9) }
