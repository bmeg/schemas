...
func (*OntologyTerm) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*Individual) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*Biosample) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*DrugTherapy) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
func (*RadiationTherapy) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (*ClinicalFollowup) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*Cohort) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*IndividualCohort) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func init() { proto.RegisterFile("bmeg/clinical.proto", fileDescriptor0) }
